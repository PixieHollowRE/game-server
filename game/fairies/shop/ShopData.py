    ...
    NPCShop(
        ...
        collections=[
            ...
            ShopCollection(
                ...
                currencyId=FairiesConstants.DAISY_PETALS,
                items=[
                    ShopItem(itemId=14091, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14092, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14093, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14094, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14095, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14096, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14097, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14098, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14099, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14100, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14101, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14102, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14103, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14104, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14105, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14106, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14107, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14108, price=5, goldPrice=1, specialType=3),
                    ShopItem(itemId=14028, price=5, goldPrice=1, specialType=3),
