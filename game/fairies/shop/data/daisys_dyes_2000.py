    ...
    collections=[
        ShopCollection(
            ...
            items=[ # 72
                ...
                ShopItem(itemId=14188, price=5, goldPrice=1), # Dahlia Pink
                ...
                ShopItem(itemId=14054, price=5, goldPrice=1), # Peony Pink
                ...
                ShopItem(itemId=14034, price=5, goldPrice=1), # Primrose Pink
                ShopItem(itemId=14131, price=5, goldPrice=1), # Plumeria Pink
                ShopItem(itemId=14181, price=5, goldPrice=1), # Cupcake Pink
                ShopItem(itemId=14044, price=5, goldPrice=1), # Plumblossom Pink
                ShopItem(itemId=14080, price=5, goldPrice=1), # Pomegranate Purple
                ShopItem(itemId=14285, price=5, goldPrice=1), # Jazzberry Red
                ShopItem(itemId=14144, price=5, goldPrice=1), # Petal Pink
                ShopItem(itemId=14288, price=5, goldPrice=1), # Sparkle Pink
                ShopItem(itemId=14225, price=5, goldPrice=1), # Eggplant Purple
                ShopItem(itemId=14283, price=5, goldPrice=1), # Thistle Pink
                ShopItem(itemId=14015, price=5, goldPrice=1), # Lilac Purple
                ...
                ShopItem(itemId=14274, price=5, goldPrice=1), # Bellflower Purple
                ...
                ShopItem(itemId=14119, price=5, goldPrice=1), # Petunia Purple
                ShopItem(itemId=14052, price=5, goldPrice=1), # Lavender Purple
                ShopItem(itemId=14060, price=5, goldPrice=1), # Tyrian Purple
                ShopItem(itemId=14210, price=5, goldPrice=1), # Lotus Purple
                ShopItem(itemId=14229, price=5, goldPrice=1), # Electric Indigo
                ShopItem(itemId=14043, price=5, goldPrice=1), # Violet Purple
                ...
                ShopItem(itemId=14148, price=5, goldPrice=1), # Pots'n'Pans Purple
        ...
        ShopCollection(
            ...
            items=[ # 49
                ...
                ShopItem(itemId=14012, price=5, goldPrice=1), # Tangerine Orange
                ...
                ShopItem(itemId=14231, price=5, goldPrice=1), # Sunny Orange
                ShopItem(itemId=14242, price=5, goldPrice=1), # Amber Yellow
                ShopItem(itemId=14196, price=5, goldPrice=1), # Electric Orange
                ShopItem(itemId=14029, price=5, goldPrice=1), # Goldfish Orange
                ...
                ShopItem(itemId=14151, price=5, goldPrice=1), # Peanut Yellow
                ...
                ShopItem(itemId=14171, price=5, goldPrice=1), # Sunrise Yellow
                ...
                ShopItem(itemId=14255, price=5, goldPrice=1), # Canary Yellow
                ShopItem(itemId=14137, price=5, goldPrice=1), # Lemon Yellow
                ShopItem(itemId=14142, price=5, goldPrice=1), # Bumble Bee Yellow
                ShopItem(itemId=14009, price=5, goldPrice=1), # Daffodil Yellow
        ...
        ShopCollection(
            ...
            items=[ # 95
                ...
                ShopItem(itemId=14126, price=5, goldPrice=1), # Raindrop Blue
                ...
                ShopItem(itemId=14132, price=5, goldPrice=1), # Bubble Blue
                ShopItem(itemId=14024, price=5, goldPrice=1), # Sky Blue
                ShopItem(itemId=14155, price=5, goldPrice=1), # Frosty Blue
                ShopItem(itemId=14208, price=5, goldPrice=1), # Cerulean Blue
                ...
                ShopItem(itemId=14069, price=5, goldPrice=1), # Powder Blue
                ...
                ShopItem(itemId=14259, price=5, goldPrice=1), # Kiwi Green
                ...
                ShopItem(itemId=14019, price=5, goldPrice=1), # Sprout Green
                ShopItem(itemId=14115, price=5, goldPrice=1), # Asparagus Green
                ShopItem(itemId=14065, price=5, goldPrice=1), # Summer Green
                ...
                ShopItem(itemId=14066, price=5, goldPrice=1), # Cactus Green
        ...
        ShopCollection(
            ...
            items=[ # 72
                ...
                ShopItem(itemId=14059, price=5, goldPrice=1), # Bunny Brown
                ...
                ShopItem(itemId=14086, price=5, goldPrice=1), # Nutmeg Brown
                ...
                ShopItem(itemId=14058, price=5, goldPrice=1), # Terracotta Brown
