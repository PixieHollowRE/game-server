...
python AIServiceStart.py --mdip=localhost --mdport=6665 --logpath=D:\fairieslog\ --district_number=200000000 --district_name="Hidden Ridge" --ssid=20100000 --min_objid=30000000 --max_objid=39999999
"""
...
if not dcFileNames:
    dcFileNames = ['config/dclass/otp.dc', 'config/dclass/fairy.dc']
...
from game.fairies.ai import FairiesAIRepository
